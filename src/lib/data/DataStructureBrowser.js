/**
 * Browser-compatible Tiered Data Structure
 * Provides efficient client-side access to model and task data without Node.js dependencies
 */

// Import static data - will be bundled by build tools
